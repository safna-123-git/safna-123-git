...
<body>
    <div class="container">
        <h1 class="head2">Add New Recipe</h1>
        <form action="" method="post">
            <div class="form-group">
                <!--<label for="firstName">First Name:</label>-->
                <input type="text" id="ingname" name="ingname" placeholder="Enter the Recipe name" required>
            </div>
...
$insert="INSERT INTO `recpie` ( `dishname`, `calorie`, `protein`, `fat`, `vitamin`) VALUES ('$ingname','$calorie','$protein','$fat','$vitamins')";
echo "$insert";
