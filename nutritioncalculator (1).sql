...
(8, 'sugar', 400, 35, 20, 60),
(9, 'salt', 0, 0, 0, 0),
(10, 'ghee', 130, 0, 15, 0),
(11, 'onion', 64, 2, 0, 15),
(14, 'coconut oil', 121, 0, 13, 10),
(16, 'ginger', 23, 21, 20, 11);
...
('fath@gmail.com', '221', 1),
('fathima@gmail.com', '123', 1),
('raoof@gmail.com', 'raoof', 0),
('safna@gmail.com', '123', 1),
('salu@gmail.com', '112', 1),
('sana@gmail.com', '234', 1),
('sappu@gmail.com', 'sappuSAPPU@123', 0),
('st@gmail.com', 'staff', 1),
('trivxop338@gmail.com', '45356', 0);
...
('chicken biriyani', 2, '400', 35, 47, 40),
('idli', 3, '56', 78, 47, 20),
('fried rice', 4, '100', 23, 12, 41),
('appam', 6, '100', 20, 25, 15);
...
INSERT INTO `staff` (`staffid`, `name`, `email`, `phoneno`, `password`, `status`) VALUES
(28, 'salu', 'salu@gmail.com', '9497025980', '112', 'active'),
(29, 'fathima', 'fath@gmail.com', '9345617898', '221', 'active');
...
INSERT INTO `users` (`userid`, `username`, `email`, `phoneno`, `password`, `status`) VALUES
(40, 'sappu', 'sappu@gmail.com', 2147483647, 'sappuSAPPU@123', 'active');
...
--
ALTER TABLE `ingredient`
  MODIFY `ingid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `recpie`
--
ALTER TABLE `recpie`
  MODIFY `dishid` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
